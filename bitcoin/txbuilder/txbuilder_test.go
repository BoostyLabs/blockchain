...
func TestTxBuilder(t *testing.T) {
	...
	txBuilder := txbuilder.NewTxBuilder(params)
	...
	t.Run("BuildRuneTransferTx", func(t *testing.T) {
		...
		tests := []struct {
			...
			},
			{
				...
				expectedTxB64: "",
				outputs:       3,
				params: txbuilder.BaseRunesTransferParams{
					RuneID: runeID,
					RunesSender: &txbuilder.PaymentData{
			...
			},
			{
				...
				expectedTxB64: "",
				outputs:       2,
				params: txbuilder.BaseRunesTransferParams{
					RuneID: runeID,
					RunesSender: &txbuilder.PaymentData{
	...
	t.Run("BuildBTCTransferTx", func(t *testing.T) {
		tests := []struct {
			...
			{
				"",
			...
			{
				"",
				txbuilder.BaseBTCTransferParams{
					TransferSatoshiAmount: big.NewInt(29500), // 0.000295 BTC.
					Sender: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
	...
	t.Run("BuildBaseInscriptionTx", func(t *testing.T) {
		...
		tests := []struct {
			...
			{
				"",
				nil,
			...
			{
				"",
				nil,
				txbuilder.BaseInscriptionTxParams{
					Sender: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
			...
			{
				"",
				nil,
				txbuilder.BaseInscriptionTxParams{
					Sender: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
	...
	t.Run("BuildRuneEtchTx", func(t *testing.T) {
		...
		tests := []struct {
			...
			{
				"",
				txbuilder.BaseRuneEtchTxParams{
					InscriptionReveal: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
							{
	...
	t.Run("BuildRuneEtchTx with primine splitting factor", func(t *testing.T) {
		...
		tests := []struct {
			...
			},
			{
				...
				expectedTxB64:   "",
				expectedOutputs: 5,
				edictsSize:      2,
				pointer:         nil,
				changePresent:   false,
	...
	t.Run("Estimation check", func(t *testing.T) {
		b, err := hex.DecodeString("6a5d0b16020086c20401a09c0101")
		require.NoError(t, err)

		runestone, err := runes.ParseRunestone(b)
		require.NoError(t, err)

		taprootNotStandatdFeeData, err := txbuilder.NewEstimationElementFromStringAddress("tb1p4323ywunpl5h9x7cl8smmy6yuc7ugfr5w3l9gywrfj39fd5f86lsyjdy96", 0, 0, params)
		require.NoError(t, err)

		taprootNotStandatdFeeData.WitnessSizeVBytes.SetInt64(92)
		...
		tests := []struct {
			...
			{
				name: "BuildRuneTransferTx to m-sig",
				params: txbuilder.BaseRunesTransferParams{
					RuneID: runestone.Edicts[0].RuneID,
					RunesSender: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
							{
								TxHash:  "f13616409e6a6987b6197a4c2893d243cd4a23ea2b204af9f96f65aa29d9fcbe",
								Index:   1,
								Amount:  big.NewInt(600),
								Script:  []byte("_bitcoin_transaction_rune_script_"),
								Address: "tb1pqdq23j23hdgmk6ykkh0a5n42kg2dwqdszf4vsgnkmfkhulhluegsfrpnht",
								Runes:   []bitcoin.RuneUTXO{{RuneID: runestone.Edicts[0].RuneID, Amount: big.NewInt(200000000)}},
							},
						},
						Address: "tb1peymd09grxec8qg7tn5vqsmf7j7fhuvw9w8lua3msmzzqhr3qtfjqlj50zg",
						PubKey:  "29fa611c361355b082ee593feb368009aa9c6bd1ed36c9983edcd113fb8da33f",
					...
					FeePayer: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
							{
								TxHash:  "2b6e3c3bea6998055b0d0969c32cf72fdb1e2ecba33193ae90f0b32779ab2147",
								Index:   3,
								Amount:  big.NewInt(334447), // 0.0085 BTC.
								Script:  []byte("_bitcoin_transaction_script_"),
								Address: "tb1qglq440ewfw0sxl2fsrp6t5q8c02tm3kl3c6g75",
							},
						},
						Address: "tb1qglq440ewfw0sxl2fsrp6t5q8c02tm3kl3c6g75",
						PubKey:  "03d17661b814dfaf3f7d6e70e8d4c8f5e6fdbe780a2c0373dd06ca7d75dc19f8be",
					},
					TransferRuneAmount:         runestone.Edicts[0].Amount,
					SatoshiPerKVByte:           big.NewInt(1000), // 1 sat/vB.
					RunesRecipientAddress:      "tb1p4323ywunpl5h9x7cl8smmy6yuc7ugfr5w3l9gywrfj39fd5f86lsyjdy96",
					CommissionRecipientAddress: "tb1qpcjlum29wvcte7c8vexp8js74yxs9h7mt6xpe7",
					SatoshiCommissionAmount:    big.NewInt(33289),
				},
				expectedFee: 308,
			},
			{
				name: "BuildRuneTransferTx from m-sig",
				params: txbuilder.BaseRunesTransferParams{
					RuneID: runestone.Edicts[0].RuneID,
					RunesSender: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
						...
						Address:  "tb1p4323ywunpl5h9x7cl8smmy6yuc7ugfr5w3l9gywrfj39fd5f86lsyjdy96",
						PubKey:   "29fa611c361355b082ee593feb368009aa9c6bd1ed36c9983edcd113fb8da33f",
						FeesData: taprootNotStandatdFeeData.PaymentDataFees,
					},
					FeePayer: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
							{
					...
					TransferRuneAmount:    runestone.Edicts[0].Amount,
					SatoshiPerKVByte:      big.NewInt(1000), // 1 sat/vB.
					RunesRecipientAddress: "tb1pzrd53lm5u450r4adct3nfzhkrztnuylkjm3yj0faal75l0udnccspm5tag",
				},
				expectedFee: 429,
			},
			{
				name: "BuildBTCTransferTx",
				params: txbuilder.BaseBTCTransferParams{
					Sender: &txbuilder.PaymentData{
						UTXOs: []bitcoin.UTXO{
							{
								TxHash:  "f13616409e6a6987b6197a4c2893d243cd4a23ea2b204af9f96f65aa29d9fcbe",
								Index:   1,
								Amount:  big.NewInt(1262907),
								Script:  []byte("_bitcoin_transaction_script_"),
								Address: "tb1qufgjsr4fa26kk3kd9k46znl0kj60uyuhyrh9sg",
								Runes:   []bitcoin.RuneUTXO{{RuneID: runestone.Edicts[0].RuneID, Amount: big.NewInt(200000000)}},
							},
						},
						Address: "tb1qufgjsr4fa26kk3kd9k46znl0kj60uyuhyrh9sg",
					...
					TransferSatoshiAmount:     big.NewInt(1217572),
					SatoshiPerKVByte:          big.NewInt(1000), // 1 sat/vB.
					RecipientAddress:          "tb1pktwn4j2fu23z8jz0v74j50lnes2yxupsfru7mghxgqglfsx6fw6svx8844",
					CommissionReceiverAddress: "tb1qa73apgyj479gnqr3vcnsmr64wprkc3llm4u6gl",
					SatoshiCommissionAmount:   big.NewInt(12428),
				},
				expectedFee: 184,
			},
		}
		var estimation *big.Int
		for _, test := range tests {
			t.Run(test.name, func(t *testing.T) {
				switch p := test.params.(type) {
				case txbuilder.BaseRunesTransferParams:
					res, err := txBuilder.BuildRunesTransferTx(p)
					require.NoError(t, err)

					estimation = res.EstimatedFee
				case txbuilder.BaseBTCTransferParams:
					res, err := txBuilder.BuildBTCTransferTx(p)
					require.NoError(t, err)

					estimation = res.EstimatedFee
				}
				require.EqualValues(t, test.expectedFee, estimation.Int64())
			})
		}
	})
}
